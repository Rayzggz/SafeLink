...
def check_collision(file1_path, file2_path):
    ...
    last_pos1 = obj1[len(file1[0]) - 1]
    last_pos2 = obj2[len(file2[0]) - 1]

    sec_last_pos1 = obj1[len(file1[0]) - 2]
    sec_last_pos2 = obj2[len(file2[0]) - 2]
